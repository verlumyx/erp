...
return [
    ...
    App\Modules\Service\Providers\ServiceServiceProvider::class,
    ...
    App\Modules\ManualTransaction\Providers\ManualTransactionServiceProvider::class,
    App\Modules\Refund\Providers\RefundServiceProvider::class,
