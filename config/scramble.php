...
return [
    ...
    'info' => [
         ...
         */
        'description' => 'API para la aplicación móvil. La autenticación es por token Bearer (Laravel Sanctum): inicia sesión en `POST /api/login` y envía el token recibido en la cabecera `Authorization: Bearer {token}`.',
    ],
