...
class CreateItemCommand
{
    ...
    public function __construct(
        ...
        public readonly ?string $saleTaxId = null,
        public readonly ?string $purchaseTaxId = null,
    ...
    public static function fromRequest(CreateItemRequest $request, ?string $companyId = null): self
    {
        return new self(
            ...
            saleTaxId: $request->input('sale_tax_id'),
            purchaseTaxId: $request->input('purchase_tax_id'),
