...
class CreateItemRequest extends FormRequest
{
    ...
    {
        return $this->user()?->hasPermission('items.create') ?? false;
    }
    ...
    public function rules(): array
    {
        ...
        return [
            ...
            'sku' => [
                ...
                'string',
                'max:60',
                Rule::unique('app_items', 'sku')->where('company_id', $companyId),
            ],
            'barcode' => [
                'nullable',
                'string',
                'max:60',
                Rule::unique('app_items', 'barcode')->where('company_id', $companyId),
            ],
            ...$this->itemRules(),
        ];
    }
