...
/**
 * Línea de un pedido de venta vista como candidata a facturar.
 *
 ...
 * precio, el descuento y el impuesto viajan congelados del pedido: son las
 * condiciones que se pactaron con el cliente y no se revalúan.
 *
 * `pending_quantity` se calcula aquí y no se lee de la columna del mismo
 * nombre: esa columna es el pendiente por *despachar*, otra cuenta.
 *
 * Las relaciones las garantiza `SalesOrderInvoiceableLinesService`.
 */
class SalesOrderInvoiceableLineResource extends JsonResource
{
    /**
