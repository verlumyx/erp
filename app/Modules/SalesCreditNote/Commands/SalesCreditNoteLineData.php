...
/**
 * Una fila de `app_sales_credit_note_lines` tal como llega desde la pantalla de
 * la nota, con sus importes ya resueltos.
 *
 ...
 * acredita la línea. `base_quantity`, `unit_cost` y `line_number` son la
 * excepción: dependen del artículo, de la factura o de las líneas ya guardadas,
 * así que los resuelve el repositorio.
 *
