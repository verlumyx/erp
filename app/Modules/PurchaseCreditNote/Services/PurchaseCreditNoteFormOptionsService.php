...
/**
 * Catálogos que alimentan los selects de la nota de crédito.
 *
 ...
 *
 * Los artículos, los proveedores y las facturas de compra NO viajan aquí: son
 ...
 * `suppliers.lookup` y la factura afectada contra `purchase-invoices.lookup`,
 * los tres con `Select2Ajax`.
 */
class PurchaseCreditNoteFormOptionsService
{
     ...
     * nota saca mercancía del inventario.
     *
