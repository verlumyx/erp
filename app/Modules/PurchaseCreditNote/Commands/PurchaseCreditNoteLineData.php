...
/**
 * Una fila de `app_purchase_credit_note_lines` tal como llega desde la pantalla
 * de la nota, con sus importes ya resueltos.
 *
 ...
 * acredita la línea. `base_quantity` y `line_number` son la excepción:
 * dependen del artículo o de las líneas ya guardadas, así que los resuelve el
 * repositorio.
 *
 ...
 */
class PurchaseCreditNoteLineData
{
