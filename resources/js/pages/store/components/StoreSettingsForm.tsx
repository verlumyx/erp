...
import { ImageOff, KeyRound, Upload } from 'lucide-react';
                ...
                <div className="flex flex-col gap-4 p-5">
                    ...
                    <div className="flex flex-col gap-1.5">
                        ...
                        <p className="text-[12.5px] text-muted-foreground">
                            PNG, JPG o WebP. Se muestra en la cabecera y en la
                            pestaña del navegador.
                        </p>
                        {errors.logo && (
                            <p className="text-sm text-bad">{errors.logo}</p>
                        )}
                    </div>
                ...
                <FormFieldGrid>
                    ...
                    >
                        <Select2
                            ...
                            onChange={(option) =>
                                setData('price_list_id', option?.value ?? NONE)
                            }
                            error={!!errors.price_list_id}
                            size="md"
                        />
                    ...
                    >
                        <Select2
                            ...
                            onChange={(option) =>
                                setData('warehouse_id', option?.value ?? NONE)
                            }
                            error={!!errors.warehouse_id}
                            size="md"
                        />
