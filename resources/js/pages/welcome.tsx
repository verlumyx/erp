...
export default function Welcome() {
    ...
    const start = auth.user ? dashboard() : login();

    return (
        <>
            <Head title="StreamCRM — El CRM para revendedores de cuentas de streaming">
            ...
            <header className="site-nav">
                <div className="wrap nav-inner">
                    ...
                    <div className="nav-cta">
                        ...
                        <Link className="btn btn-brand btn-sm" href={contact()}>
                            Contáctenos
                        </Link>
                        <button
                            type="button"
            ...
            <section className="hero">
                <div className="wrap hero-grid">
                    <div className="hero-copy">
                        <span className="pill">
                            <span className="dot" /> Hecho para revendedores de
                            streaming
                        </span>
                        <h1>
                            Vende cuentas de streaming{' '}
                            <span className="grad">sin perder el control.</span>
                        </h1>
                        <p className="lead">
                            StreamCRM reúne tus clientes, perfiles, vencimientos
                            y cobros en un solo panel. Sabe quién paga, quién
                            debe y qué perfil vence — antes de que te escriban.
                        </p>
                        ...
                        <div className="shot">
                            <div className="shot-bar">
                                ...
                                <span className="shot-url">
                                    app.streamcrm.cl/resumen
                                </span>
                            </div>
                            <img
                                src="/assets/hero-dashboard.png"
                                alt="Panel de StreamCRM"
                            />
                        </div>
            ...
            <section className="strip" id="plataformas">
                <div className="wrap">
                    <p className="strip-label">
                        Gestiona perfiles y cuentas de todas las plataformas
                    </p>
            ...
            <section className="section" id="funciones">
                <div className="wrap">
                    <div className="sec-head">
                        ...
                        <p>
                            Las herramientas que un revendedor necesita de
                            verdad — sin planillas interminables ni
                    ...
                    <div className="feat-grid">
                        <div className="feat">
                            ...
                            <p>
                                Cada perfil con su fecha. Mira de un vistazo lo
                                que vence hoy, esta semana o lo que ya caducó.
                            </p>
                        </div>
                        <div className="feat">
                            ...
                            <p>
                                Registra cada pago y mira al instante quién está
                                al día y quién te debe, con el total por cobrar.
                            </p>
                        </div>
                        <div className="feat">
                            ...
                            <p>
                                Sabe cuántos cupos tienes disponibles por cuenta
                                y vende sin sobrevender ni dejar plata sobre la
                                mesa.
                            </p>
                        </div>
                        <div className="feat">
                            ...
                            <p>
                                Avisa vencimientos y cobra con un clic. El
                                mensaje se abre listo con el número del cliente.
                            </p>
                        </div>
                        <div className="feat">
                            ...
                            <p>
                                Costo de la cuenta vs. precio de venta. Conoce
                                tu ganancia real mes a mes, no solo lo que
                                entra.
                            </p>
                        </div>
                        <div className="feat">
                            ...
                            <p>
                                Netflix, Disney+, Spotify y más, en una misma
                                vista. Maneja varias marcas o socios por
                                separado.
                            </p>
                        </div>
                    </div>
                ...
                <div className="wrap">
                    <div className="showcase">
                        <div className="showcase-copy">
                            ...
                            <p>
                                Ingresos, ganancia, ocupación de perfiles y lo
                                que está por vencer — todo en la primera
                                pantalla. Empieza el día sabiendo exactamente
                                qué hacer.
                            </p>
                            <ul className="check-list">
                                ...
                                <li>
                                    ...
                                    Ocupación de perfiles e inventario
                                    disponible
                                </li>
                                <li>
                                    <span className="ck">
                ...
                <div className="wrap">
                    <div className="showcase flip">
                        <div className="showcase-copy">
                            ...
                            <h2>
                                Cada cliente, perfil y pago en un solo lugar
                            </h2>
                            <p>
                                Busca, filtra y abre la ficha de cualquier
                                cliente: sus perfiles activos, historial de
                                pagos, deuda y contacto directo por WhatsApp.
                            </p>
                            <ul className="check-list">
                                <li>
                                    <span className="ck">
                        ...
                        <div className="showcase-media">
                            <div className="shot">
                                <div className="shot-bar">
                                    ...
                                    <i />
                                    <span className="shot-url">
                                        app.streamcrm.cl/clientes
                                    </span>
                                </div>
                                <img
                                    src="/assets/shot-clientes.png"
                    ...
                    <div className="band">
                        <div className="band-grid">
                            <div className="band-stat">
                                ...
                                <div className="bl">
                                    Perfiles gestionados con StreamCRM
                                </div>
                            </div>
                            <div className="band-stat">
                            ...
                            <div className="band-stat">
                                ...
                                <div className="bl">
                                    Menos tiempo perdido en cobranzas
                                </div>
                            </div>
                        </div>
                    </div>
            ...
            <section className="section soft" id="precios">
                <div className="wrap">
                    <div className="sec-head">
                        ...
                        <p>
                            Sin contratos ni sorpresas. Cambia o cancela tu plan
                            cuando quieras.
                        </p>
                    </div>
                    <div className="price-grid">
                        <div className="price">
                            <h3>Inicial</h3>
                            <p className="desc">
                                Para quien recién empieza a revender.
                            </p>
                            <div className="amt">
                                $0<small> /mes</small>
                            </div>
                        ...
                        <div className="price feat-plan">
                            ...
                            <h3>Pro</h3>
                            <p className="desc">
                                Para el revendedor que ya tiene cartera.
                            </p>
                            <div className="amt">
            ...
            <section className="section">
                <div className="wrap">
                    <div className="cta-card">
                        ...
                        <p>
                            Crea tu cuenta gratis y ten tu primer cliente
                            cargado en minutos.
                        </p>
                ...
                <div className="wrap">
                    <div className="foot-grid">
                        <div className="foot-about">
                            ...
                            <p>
                                El CRM hecho para revendedores de cuentas y
                    ...
                    <div className="foot-bottom">
                        <span>
                            © 2026 StreamCRM. Todos los derechos reservados.
                        </span>
