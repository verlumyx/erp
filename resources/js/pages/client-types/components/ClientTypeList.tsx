...
export function ClientTypeList({
    ...
    const [filters, setFilters] = useState<ClientTypeFilters>(initialFilters);
    ...
    const handleClear = () => {
        setFilters({});
        router.get(clientTypes.index(companyId).url);
    };

    const handleToggleStatus = (clientType: ClientType) => {
        router.put(
        ...
        <div className="flex flex-col gap-5">
            <div className="flex flex-col items-start justify-between gap-4 sm:flex-row">
                ...
                <Button
                    ...
                    onClick={() =>
                        router.visit(clientTypes.create(companyId).url)
                    }
                >
                    <Plus />
                    Nuevo tipo
                ...
                <div className="grid grid-cols-1 gap-4 sm:grid-cols-2 lg:grid-cols-3">
                    {(
                        [
                            ['name', 'Nombre'],
                            ['code', 'Código'],
                        ] as Array<[keyof ClientTypeFilters, string]>
                    ).map(([key, label]) => (
