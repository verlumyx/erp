        ...
        <FormLayout onSubmit={handleSubmit}>
                ...
                <FormFieldGrid>
                    ...
                    <div className="flex flex-col gap-1.5">
                        ...
                        <span className="text-[12px] text-muted-foreground">
                            Opcional: hay anticipos que no nacen de una orden
                        </span>
            ...
            >
                <FormFieldGrid>
                    ...
                    <div className="flex flex-col gap-1.5">
                        ...
                        />
                        <span className="text-[12px] text-muted-foreground">
                            Se entrega al confirmar el pago que genera aprobarlo
                        </span>
                        {errors.amount && (
            ...
            <FormSummary>
                ...
                <p className="text-[12.5px] leading-relaxed text-muted-foreground">
                    Guardarlo no mueve dinero. Aprobarlo genera el pago que lo
                    entrega, y confirmar ese pago es lo que le da crédito al
                    proveedor.
                </p>
            </FormSummary>
