...
export function PurchaseInvoiceList({
    ...
    const [filters, setFilters] =
        useState<PurchaseInvoiceFilters>(initialFilters);

    /**
     * El filtro de proveedor busca contra el servidor, así que de un id que
     * llega en la URL solo sabemos su etiqueta si alguna factura listada lo
    ...
    const applyFilters = (next: PurchaseInvoiceFilters) => {
        setFilters(next);
        router.get(
            purchaseInvoices.index(companyId).url,
    ...
    const handleClear = () => {
        setFilters({});
        router.get(purchaseInvoices.index(companyId).url);
    };
        ...
        <div className="flex flex-col gap-5">
            <div className="flex flex-col items-start justify-between gap-4 sm:flex-row">
                ...
                <Button
                    ...
                    onClick={() =>
                        router.visit(purchaseInvoices.create(companyId).url)
                    }
                >
                    <Plus />
                    Nueva factura
            ...
            <div className="rounded-lg border bg-card p-4">
                <div className="grid grid-cols-1 gap-4 sm:grid-cols-2 lg:grid-cols-4">
                    ...
                    <div className="space-y-2">
                        <Label htmlFor="filter-payment-status">Pago</Label>
                        <Select2
                ...
                <div className="flex flex-col">
                    {rows.map((invoice) => (
                        ...
                        >
                            ...
                            <div className="hidden lg:block">
                                <StatusPill
                                    kind={STATUS_PILL_KIND[invoice.status]}
                                >
