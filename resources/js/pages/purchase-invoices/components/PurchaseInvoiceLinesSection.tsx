...
import { lineAmounts } from '../hooks/usePurchaseInvoiceForm';
import { formatAmount } from '../types/PurchaseInvoice';

/** Valor del select cuando la línea no lleva impuesto: '' no lo distingue. */
const NO_TAX = 'none';

/**
 * 3.2 Líneas de la factura. Cada fila fija artículo, unidad, cantidad y costo;
 * el importe que se muestra es el mismo que recalcula el backend al guardar.
 */
export function PurchaseInvoiceLinesSection() {
    const {
        data,
        errors,
        catalog,
