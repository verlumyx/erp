...
export function ImportList({
    ...
    const applyFilters = (next: ImportFilters) => {
        setFilters(next);
        router.get(
            imports.index(companyId).url,
    ...
    const handleClear = () => {
        setFilters({});
        router.get(imports.index(companyId).url);
    };
        ...
        <div className="flex flex-col gap-5">
                ...
                <div className="grid grid-cols-1 gap-4 sm:grid-cols-2 lg:grid-cols-4">
                    ...
                    <div className="space-y-2">
                        ...
                        <Input
                            id="filter-reference"
                            type="text"
                            placeholder="Embarque o guía aérea..."
                    ...
                    <div className="space-y-2">
                        <Label htmlFor="filter-method">Reparto</Label>
                        <Select2
            ...
            <Card className="gap-0 overflow-hidden rounded-2xl py-0">
                ...
                <div className="px-5 py-3.5 text-[13px] font-semibold text-muted-foreground">
                    {rows.length} de {meta.total} expediente
                    {meta.total !== 1 ? 's' : ''}
                </div>
            </Card>
        </div>
