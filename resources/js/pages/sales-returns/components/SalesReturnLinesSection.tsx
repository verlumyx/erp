...
import { REASON_LABELS, type SalesReturnReason } from '../types/SalesReturn';
...
/**
 * 7.2 Líneas de la devolución. Cada fila dice qué vuelve, cuánto y a qué bodega
 * reingresa; el precio con el que se acredita y el costo con el que vuelve los
 * pone el backend copiándolos de la venta original, y el lote y la serie los
 * pide la entrada que la devolución genera al confirmarse.
 */
    ...
    return (
        <div className="flex flex-col gap-4 p-5">
            ...
            {data.lines.map((line, index) => {
                ...
                const hasDetail =
                    line.sales_invoice_line_id !== '' || line.reason !== '';
                ...
                return (
                    ...
                    >
                        <div className="grid grid-cols-1 items-start gap-3 sm:grid-cols-2 lg:grid-cols-[2.2fr_1fr_1.2fr_1.4fr_auto]">
