                    ...
                    {twoFactorEnabled ? (
                        <div className="flex flex-col items-start justify-start space-y-4">
                            ...
                            <p className="text-muted-foreground">
                                ...
                                iniciar sesión, el cual puedes obtener desde
                        ...
                        <div className="flex flex-col items-start justify-start space-y-4">
                            ...
                            <p className="text-muted-foreground">
                                Al activar la autenticación de dos factores, se
                                te solicitará un PIN seguro al iniciar sesión.
                                Puedes obtenerlo desde una aplicación compatible
